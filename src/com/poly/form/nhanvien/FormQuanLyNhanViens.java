...
//        txtngaysinh.setText(formatDate(nv.getNgaySinh()));
...
// Hàm chuyển đổi định dạng ngày
    ...
    NhanVien readForm() {
        ...
        // Kiểm tra xem có phải đang thêm mới hay cập nhật
        if (isThemMoi) {
            // Nếu đang thêm mới, đặt ThoiGianTao thành thời gian hiện tại
            thoiGianTao = new Date();
        }

        return new NhanVien(username, name, madd, sdt, ngaysinh, email, gt, diachi, status, thoiGianTao, thoiGianSua);
    }
...
//        else if (!Pattern.matches("^[a-zA-Z ]+$", txttennv.getText())) {
//            JOptionPane.showMessageDialog(this, "Tên chỉ được chứa chữ cái ");
//            return false;
//        }
...
//        }
    ...
    private void initComponents() {
        ...
        tblqlnhanvien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "UserName", "Ho&Ten", "Email", "Số Điện Thoại", "Giới Tính", "Trạng Thái", "Ngày Sinh"
            }
        ) {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(24, 24, 24)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(datesua, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnexxportexcel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnupdatenv, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnupdatenvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdatenvActionPerformed
        if (index != -1) {
            Notifications.getInstance().show(Notifications.Type.INFO, Notifications.Location.TOP_CENTER, "Bạn Chưa Chọn Dòng Cần Sửa");
            return;
        } else {
            ...
            if (confirmResult == JOptionPane.YES_OPTION) {
                ...
                // Xử lý trường hợp khi người dùng chọn "No"
            }
        }
    ...
    private void btndeletenvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeletenvActionPerformed
        if (index != -1) {
            Notifications.getInstance().show(Notifications.Type.INFO, Notifications.Location.TOP_CENTER, "Bạn Chưa Chọn Dòng Cần Xóa");
            return;
        } else {
